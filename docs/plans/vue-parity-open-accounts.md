...
> **wave 137 新挂一条，是这张表上唯一「已归因、待修」的**：
...
e2e-parity       95        台账 199 行 / 87 样本（wave 128/129/132/133 各一个失败终态，wave 134 加一个「加载中」终态）
