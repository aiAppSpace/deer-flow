...
export const zhCN: Translations = {
  ...
  */
  ...
  agents: {
    ...
    verifying: "正在验证智能体...",
    retry: "重试",
    creationError: "智能体创建失败",
    saveNotAccepted: "保存请求未被接受。",
    creationLoadFailed: "无法读取已创建的智能体。",
    creationVisibilityUnavailable: "暂时还无法读取已创建的智能体，请重试验证。",
    creationRequestFailed: "无法发起智能体创建请求。",
    creationMissingToolResult: "运行已结束，但没有 setup_agent 工具结果。",
    creationRunFailed: "智能体创建运行失败。",
    saveRequested:
    ...
    settingsInvalidModel: "请选择可用模型。",
    settingsModelsLoading: "正在加载模型能力…",
    settingsModelsFailed: "加载模型能力失败",
    settingsModelUnavailable: "不可用",
    settingsReasoningLow: "低",
    settingsReasoningMedium: "中",
    settingsReasoningHigh: "高",
    settingsCancel: "取消",
    settingsSave: "保存",
    settingsSaving: "正在保存…",
    settingsSaveFailed: "保存模型设置失败",
    loading: "正在加载智能体…",
    loadFailed: "加载智能体失败",
    ...
    cardSkillsNone: "无技能",
    cardToolGroups: "工具组",
    cardToolGroupsAll: "全部已配置工具组",
    cardToolGroupsNone: "不启用已配置工具组",
  },
  ...
  browser: {
    ...
    back: "后退",
    forward: "前进",
    urlPlaceholder: "输入网址后按 Enter",
    close: "关闭浏览器",
    retryNavigation: "重试导航",
    retryLive: "重试实时浏览器",
    stopLiveControl: "停止实时控制",
    takeLiveControl: "接管实时浏览",
    connectingFrame: "正在连接实时浏览器…",
    connectingFrameDescription: "正在等待第一帧实时画面。",
    noFrame: "暂无浏览器活动",
    noFrameDescription:
  ...
  marketing: {
    ...
    caseStudyItems: [
      {
        title: "预测 2026 年智能体趋势与机遇",
        description:
          "创建一份网页形式的深度研究报告，预测 2026 年智能体技术的趋势与机遇。",
      },
      {
        title: "基于小说《傲慢与偏见》生成视频",
        description: "搜索《傲慢与偏见》中的场景，再生成参考图片和视频。",
      },
      {
        title: "哆啦 A 梦讲解 MOE 架构",
        description: "生成一组面向青少年的哆啦 A 梦漫画，讲解 MOE 架构。",
      },
      {
        title: "泰坦尼克号数据集探索性分析",
        description:
          "探索泰坦尼克号数据集，通过可视化和洞察找出影响生还率的因素。",
      },
      {
        title: "观看 Y Combinator 视频并开展深度研究",
        description: "观看 Y Combinator 视频，研究其中面向技术创业者的建议。",
      },
      {
        title: "收集并总结李飞飞博士的播客",
        description: "收集李飞飞博士近期参与的播客，并整理成一份总结报告。",
      },
    ],
  },
  login: {
    ...
    retry: "重试",
    authFailed: "身份验证失败。",
    callbackSigningIn: "正在登录...",
    callbackRedirecting: "正在跳转...",
    callbackFailedRedirect: "认证失败，正在跳转到登录页...",
    callbackUnavailableRedirect: "Gateway 暂时不可用，正在跳转到恢复页...",
    errors: {
