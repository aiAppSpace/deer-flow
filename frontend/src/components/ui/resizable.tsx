...
function ResizableHandle({
  ...
  return (
    <ResizablePrimitive.Separator
      ...
      className={cn(
        /*
          The drag target is the `::after` overlay, not the 1px line; shadcn ships
          it at `w-1` (4px). Four pixels is below anything you can reliably hit
          with a mouse and far below what a trackpad or a shaky hand can manage,
          and the divider is the only way to resize the panel. Widened to 16px
          (still invisible — the line itself is untouched, so nothing moves by a
          pixel), which is in line with what desktop apps give a sash.
        */
